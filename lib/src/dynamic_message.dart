...
Map<String, FieldDescriptorProto_Type> _genMapType2(DescriptorProto dp) {
...
Map<String, int> _genMapType(DescriptorProto dp) {
  // int using PbFieldType
  Map<String, int> m = {};
  for (var fd in dp.field) {
    late int val;
    switch (fd.type) {
      ...
      case FieldDescriptorProto_Type.TYPE_ENUM:
        ...
        break;
      case FieldDescriptorProto_Type.TYPE_SFIXED32:
        val = PbFieldType.OSF3;
        break;
      case FieldDescriptorProto_Type.TYPE_SFIXED64:
        val = PbFieldType.OSF6;
        break;
      case FieldDescriptorProto_Type.TYPE_SINT32:
        val = PbFieldType.OS3;
        break;
